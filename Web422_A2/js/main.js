...
*
* Name: Himanshu Nayyar Student ID: 160694238 Date: 10/18/2024
*
********************************************************************************/
...
async function loadMovieData(title = null) {
    const url = title 
    ? `https://moviesapi-hjry.onrender.com/api/movies?page=1&perPage=${perPage}&title=${title}`
    : `https://moviesapi-hjry.onrender.com/api/movies?page=${page}&perPage=${perPage}`;
    ...
    async function loadMovieDetails(movieId) {
        try {
            const response = await fetch(`https://movies-api-rho-five.vercel.app/api/movies/${movieId}`);
